...
### 2. Prepare Local Folder for VM
 ...
 2. Download AWS KeyPair (Putty) and connect to server via SSH
    ```
    Download  sc216_FormR-KeyPair.pem
  ...
  4. Create bin folder for bash scripts
     ```
     sudo mkdir /home/_
     sudo mkdir /home/_/bin
     echo #!/bin/sh  >/home/_/bin/hello.sh
     echo #!/bin/sh >>/home/_/bin/hello.sh
     chmod 777   /home/_/bin/hello.sh
     hello.sh
     ```
...
10. sudo mysqladmin -p -u root version
...
11. Allow remote access to MySQL
    ...
    mysql> CREATE USER 'sco'@'%' IDENTIFIED WITH mysql_native_password BY '!PassWord1';
    mysql> CREATE USER 'robin'@'69.251.71.138' IDENTIFIED WITH mysql_native_password BY '!PassWord1';
...
12. Grant ALL privileges to Users, robin and bruce
    ...
    ```
    sudo mysql -p
    mysql> CREATE USER 'io'@'%'    IDENTIFIED WITH mysql_native_password BY '!PassWord2';
    mysql> CREATE USER 'bruce'@'%' IDENTIFIED WITH mysql_native_password BY '!PassWord5';
